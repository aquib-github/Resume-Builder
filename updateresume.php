                        ...
                        foreach ($exps as $exp) {
                            ...
                            <div class="p-2 border rounded">
                                <div class="d-flex justify-content-between">
                                    ...
                                    <a href="actions/deleteexperince.action.php?id=<?=intval($exp['id'])?>&resume_id=<?=intval($resume['id'])?>&slug=<?=urlencode($resume['slug'])?>" onclick="return confirm('Delete this experience?')"><i class="bi bi-x-lg"></i></a>
                                </div>
                        ...
                        foreach ($edus as $edu) {
                            ...
                            <div class="p-2 border rounded">
                                <div class="d-flex justify-content-between">
                                    ...
                                    <a href="actions/deleteeducation.action.php?id=<?=intval($edu['id'])?>&resume_id=<?=intval($resume['id'])?>&slug=<?=urlencode($resume['slug'])?>" onclick="return confirm('Delete this education?')"><i class="bi bi-x-lg"></i></a>
                                </div>
                        ...
                        foreach ($skills as $skill) {
                            ...
                            <div class="p-2 border rounded">
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <a href="actions/deleteskill.action.php?id=<?=intval($skill['id'])?>&resume_id=<?=intval($resume['id'])?>&slug=<?=urlencode($resume['slug'])?>" onclick="return confirm('Delete this skill?')"><i class="bi bi-x-lg"></i></a>
                                </div>
                            </div>
                            </div>
                            <?php
...
<div class="modal fade" id="addskill" tabindex="-1" aria-labelledby="addSkillLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-body">
      <form method="post" action="actions/addskills.action.php" class="row g-3">
      <input type="hidden" name="resume_id" value="<?=intval($resume['id'])?>" />
      <input type="hidden" name="slug" value="<?=$fn->esc($resume['slug'])?>" />
  <div class="col-12">
