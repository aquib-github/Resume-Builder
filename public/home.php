<?php
// Home Page — landing page for guest users
...
<nav class="navbar bg-body-tertiary shadow mb-4">
    <div class="container">
        <a class="navbar-brand" href="<?= BASE_URL ?>public/home.php">
            <img src="<?= BASE_URL ?>public/assets/images/logo.png" alt="Logo" height="35" class="d-inline-block align-text-top">
            Resume Builder
        </a>
        <div>
            <a href="<?= BASE_URL ?>public/pages/public/login.php" class="btn btn-sm btn-outline-primary me-2"><i class="bi bi-box-arrow-in-right"></i> Login</a>
            <a href="<?= BASE_URL ?>public/pages/public/register.php" class="btn btn-sm btn-primary"><i class="bi bi-person-plus"></i> Register</a>
        </div>
    </div>
</nav>
...
<div class="container">
    <div class="row align-items-center bg-white rounded shadow p-5">
        <div class="col-md-6">
            ...
            <div class="mt-4">
                <a href="<?= BASE_URL ?>public/pages/public/register.php" class="btn btn-primary btn-lg px-4 me-2">Get Started for Free</a>
                <a href="<?= BASE_URL ?>public/pages/public/login.php" class="btn btn-outline-secondary btn-lg px-4">Login</a>
            </div>
        </div>
